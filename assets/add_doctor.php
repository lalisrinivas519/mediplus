...
<html lang="en">
                  ...
                  <div class="col-md-6" >
                     <div class="card" >
                        ...
                        <div class="body">
                           <div class="row clearfix">
                                 <div class="col-sm-12">
						<?php $DOC='DOC'.rand(100000,999999999);?>
                           <div class="form-group">
                              <input type="text" class="form-control" name="userid" placeholder="Doctor Id" value="<?php echo $DOC;?>">
                           </div>
                        </div>
                              <div class="col-sm-12">
                                 <div class="form-group">
							   ...
							   <div class="col-sm-12">
                                 <div class="form-group">
                                    <input type="date" data-provide="datepicker" data-date-autoclose="true" name="dob" class="form-control" placeholder="Date of Birth" required>
                                 </div>
                              </div>
							   <div class="col-sm-12">
                                 <div class="form-group">
                                    <input type="text" class="form-control" name="qualification" required placeholder="Qualification" required>
                                 </div>
                              </div>
							    <div class="col-sm-12">
                                 <div class="form-group">
   ...
   if(isset($_POST['submit'])) {
    ...
    $password=$_POST['password'];
      ...
      $query_contact=mysqli_query($con,"INSERT INTO `doctor`(`userid`,`name`, `mobile`, `email`, `gender`, `dob`, `qualification`, `designation`, `speciality`, `department`, `address`, `city`, `state`, `country`, `password`) 
	  VALUES ('$userid','$name','$mobile','$email','$gender','$dob','$qualification','$designation','$department','$speciality','$address','$city','$state','$country','$password')");
	  if($query_contact){
