   ...
   <body class="theme-cyan">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Doctor List</h2>
                        <ul class="breadcrumb">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    <thead class="thead-dark">
									 ...
									 <?php
									$i=1;
									$query = mysqli_query($con,"select * from doctor order by id desc");
    ...
    if(isset($_POST['delete_id'])){
        ...
        $query=mysqli_query($con,"DELETE FROM `doctor` WHERE `id`='$id'");
               echo '<script>alert("Delete Successful.");window.location.assign("doctor_list.php");</script>';
