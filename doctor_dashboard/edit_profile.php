                     ...
                     <div class="card" >
                        ...
                        <div class="body">
                           ...
                           <div class="row clearfix">
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    <input type="text" name="date" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Date of Birth" required>
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group">
...
if(isset($_POST['submit'])){
	...
	$state=$_POST['state'];
		...
		$query=mysqli_query($con,"UPDATE `doctor` SET `mobile`='$mobile',`email`='$email',`address`='$address',`city`='$city',`state`='$state',`country`='$country' WHERE `userid`='$userid'");
