   ...
   <body class="theme-cyan">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    <thead class="thead-dark">
									 ...
									 <?php
									$i=1;
									$query = mysqli_query($con,"SELECT * FROM employee WHERE designation='employee'");
    ...
    if(isset($_POST['delete_id'])){
        ...
        $query=mysqli_query($con,"DELETE FROM `employee` WHERE `id`='$id'");
               echo '<script>alert("Delete Successful.");window.location.assign("employee_list.php");</script>';
