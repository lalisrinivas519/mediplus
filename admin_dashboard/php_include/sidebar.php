<div id="left-sidebar" class="sidebar">
            <div class="sidebar-scroll">
               <div class="user-account">
                  ...
                  <div class="dropdown">
                     <span>Welcome,</span>
                     <a href="javascript:void(0);" strong>Mr Golla Giribabu</strong></a>
                  ...
                  <div class="tab-pane active" id="menu">
                     <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                           ...
                           <li>
                              <a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Profile</span> </a>
                              <ul>
                           ...
                           <li>
                              <a href="#Widgets" class="has-arrow"><i class="icon-puzzle"></i><span>Medicine Report</span></a>
                              <ul>
                           ...
                           <li>
                              <a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Patient Report</span> </a>
                              <ul>
							   <li><a href="add_patient.php">Add Patient</a></li>
                                 <li><a href="allot_bed.php">Allot Bed</a></li>
                                 <li><a href="allot_doctor.php">Allot Doctor</a></li>
                                  <li><a href="bed_list.php">Bed List</a></li>
                              </ul>
                           </li>
                         
                           <li>
                              <a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Employee Menu</span> </a>
                              <ul>
                                 <li><a href="add_employee.php">Add Employee</a></li>
                                 <li><a href="nurse_list.php">Nurse List</a></li>
                                 <li><a href="employee_list.php">Employee List</a></li>
								</ul>
                           </li>
                           <li>
                              <a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>Doctor Menu</span> </a>
                              <ul>
                           ...
                           <li><a href="logout.php" class="has-arrow"><i class="icon-lock"></i>Log out</a></li>
                           </ul>
                     </nav>
                  </div>
